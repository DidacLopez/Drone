...
Bebop.prototype.connect = function(callback) {
  this.discover(function() {
    ...
    setInterval(function() {
      this._writePcmd(this._generatePCMD(this._pcmd));
    }.bind(this), 25);

    setInterval(function() {
      this._sendPcmdACK(this._generatePCMD(this._pcmd));
    }.bind(this), 3000);
...
Bebop.prototype._writePcmd = function(packet) {
  if(this._pcmd_isSend){
    this._c2dClient.send(packet, 0, packet.length, this.c2dPort, this.ip,
      function(err) {
        if (err) {
          throw err;
...
Bebop.prototype._sendPcmdACK = function(packet) {
  if(!this._pcmd_isSend){
    this._c2dClient.send(packet, 0, packet.length, this.c2dPort, this.ip,
      function(err) {
        if (err) {
...
Bebop.prototype._pcmd_isSend = false;
